...
def movie_predictor():
    ...
    put_text("This is a free and fun tool made with Python where people can make up a movie plot and find similar 2000's movies.")
    put_text("Or if you want, you can type in a 2000's movie title and see what other 2000's movies in the database are similar based on its plot.")
    ...
    #titles.append(" ")
    data = input_group("You can either input your own plot or the title of a movie", [textarea("Movie plot summary goes here! (25 character minimum)", required = False, name = "Plot"), input("Or type in a 2000's movie title! (Case sensitive - must match IMDb title)", name = "Title", required = False)])
    #data = input_group("You can either input your own plot or the title of a movie", [textarea("Movie plot summary goes here! (25 character minimum)", required = False, name = "Plot"), select("Or select a 2000's movie title!", name = "Title", required = False, options = np.sort(titles), help_text = "Hint: Try typing to search for a movie", value = " ")])
